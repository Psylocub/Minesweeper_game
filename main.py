...
class MineSweeper:
    ...
    def create_settings_win(self):
        ...
        tk.Label(win_settings, text='Row quantity').grid(row=0, column=0)
        row_entry = tk.Entry(win_settings)
        row_entry.insert(0, MineSweeper.ROW)
        row_entry.grid(row=0, column=1, padx=20, pady=20)
        tk.Label(win_settings, text='Row quantity').grid(row=1, column=0)
        column_entry = tk.Entry(win_settings)
        column_entry.insert(0, MineSweeper.COLUMN)
        column_entry.grid(row=1, column=1, padx=20, pady=20)
        tk.Label(win_settings, text='Row quantity').grid(row=2, column=0)
    ...
    def change_settings(self, row: tk.Entry, column: tk.Entry, mines: tk.Entry):
        try:
            ...
            showerror('Error', 'You have entered wrong parameter!')
            return
